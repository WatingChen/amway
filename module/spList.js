define(function() {
    ...
    class SPList{
        constructor(){
            ...
            this.searchkeywards = localStorage.getItem("splbName") ? JSON.parse(localStorage.getItem("splbName")) : {"splbName":""};
            this.init();
        }
        searchDisplay(){
            var that = this;
        ...
        addEvent(){
            this.keywards = this.searchkeywards.splbName;
            // console.log(this.keywards);
